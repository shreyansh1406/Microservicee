...
public class Exam {
	...
	public Exam(Long examcode, String examname, String duration, String price, long pscore) {
		super();
	...
	public String toString() {
		return "Exam [examcode=" + examcode + ", examname=" + examname + ", duration=" + duration + ", price=" + price
				+ ", pscore=" + pscore + "]";
	}
